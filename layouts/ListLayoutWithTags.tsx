      ...
      <>
        <div>
          ...
          <div className="flex sm:space-x-24">
            <div
                className="hidden max-h-screen h-full sm:flex flex-wrap bg-gray-100 dark:bg-zinc-800/50 shadow-lg transition-colors duration-200 pt-5 rounded min-w-[280px] max-w-[280px]">
                ...
                {displayPosts.map((post) => {
                  ...
                  return (
                      <li key={path} className="py-5 sm:-ml-6">
                        <article
                            className="space-y-2 flex flex-col xl:space-y-0 hover:bg-gray-100 hover:dark:bg-zinc-800/90 p-2 rounded-lg">
                          <dl>
